...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_pe xil_defaultlib.ila_pe xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_pe -key {Behavioral:sim_1:Functional:ila_pe} -tclbatch cmd.tcl -protoinst "protoinst_files/Accelerator_block_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_pe.wdb xsim.dir)
