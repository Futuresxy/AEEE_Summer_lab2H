...
#
# Generated by export_simulation on Thu Apr 11 16:58:32 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './ila_conv.sh' script.

./ila_conv.sh -reset_run
...
./ila_conv.sh -noclean_files

For more information on the script, please type './ila_conv.sh -help'.
