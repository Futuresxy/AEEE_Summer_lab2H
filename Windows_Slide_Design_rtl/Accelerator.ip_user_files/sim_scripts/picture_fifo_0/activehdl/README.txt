...
#
# Generated by export_simulation on Sat Apr 06 18:49:34 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './picture_fifo_0.sh' script.

./picture_fifo_0.sh -reset_run
...
./picture_fifo_0.sh -noclean_files

For more information on the script, please type './picture_fifo_0.sh -help'.
