...
HD_PWD='E:/Accelerator/Accelerator_Test_Windows/Accelerator.runs/ila_pe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_pe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_pe.tcl
