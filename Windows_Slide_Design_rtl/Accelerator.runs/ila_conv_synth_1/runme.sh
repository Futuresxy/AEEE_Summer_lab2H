...
HD_PWD='E:/Accelerator/Accelerator_Test_Windows/Accelerator.runs/ila_conv_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_conv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_conv.tcl
