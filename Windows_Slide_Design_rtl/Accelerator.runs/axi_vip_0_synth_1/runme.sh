...
HD_PWD='E:/Accelerator/Accelerator_Test_Windows/Accelerator.runs/axi_vip_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_vip_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_vip_0.tcl
