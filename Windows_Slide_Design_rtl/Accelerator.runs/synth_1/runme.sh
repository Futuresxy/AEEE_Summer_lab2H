...
HD_PWD='E:/Accelerator/Accelerator_Test_Windows/Accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Windows_data_Test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Windows_data_Test_wrapper.tcl
