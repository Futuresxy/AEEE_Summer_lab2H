...
HD_PWD='E:/Accelerator/Accelerator_Test_Windows/Accelerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Windows_data_Test_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Windows_data_Test_wrapper.tcl -notrace
